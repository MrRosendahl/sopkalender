...
//   node .\area-updater.js .\area-29.jsonc
//
//   # JSONC with comments → file:
//   node .\area-updater.js .\templates\area-29.jsonc .\area-29.jsonc
//
//   # Pure JSON (no comments):
//   node .\area-updater.js .\templates\area-29.jsonc .\area-29.json --without-month-comments
//
// ---------------------------------------------------------------------------
...
function main() {
  ...
  if (!inputPath) {
    console.error(
      "Usage: node area-updater.js <input.jsonc> [output.jsonc] [--without-month-comments]"
    );
    process.exit(1);
  }
